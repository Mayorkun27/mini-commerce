          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-lg shadow-md md:p-8 p-4 text-center">
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                ...
                <div className="space-y-2 md:text-base text-sm">
                  <div className="flex justify-between md:items-center items-start">
                    <span className="text-gray-600 whitespace-nowrap">Order ID:</span>
                    <span className="font-mono text-gray-900 text-end lg:text-base md:text-sm text-xs">{orderId}</span>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/"
                  className="bg-black text-white px-6 py-3 cursor-pointer transition-colors font-medium"
                >
                  Continue Shopping
                </Link>
                <button
                  onClick={() => window.print()}
                  className="bg-gray-100 text-gray-700 px-6 py-3 hover:bg-gray-200 cursor-pointer transition-colors font-medium"
                >
                  Print Receipt
                </button>
              </div>
